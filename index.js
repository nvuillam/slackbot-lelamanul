...
controller.configureSlackApp( 
    { 
        ...
        clientVerificationToken: process.env.SLACKAPP_CLIENT_VERIFICATION_TOKEN, 
...
var bot = controller.spawn({
    token: process.env.SLACKAPP_BOT_TOKEN 
}).startRTM();
...
// Interactive messages callbacks: redirect to global method built from callbackId
